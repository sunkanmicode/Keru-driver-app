...
const HomeNavigation = () => {
    ...
    const getTabBarVisibility = (route) => {
      const routeName =
        getFocusedRouteNameFromRoute(route) ?? "CompleteyourProfile";
       if (
         routeName === "CompleteyourProfile" ||
         routeName === "AddPersonalDetails" ||
         routeName === "UploadLicense" ||
         routeName === "AddBankDetails"
       ) {
         return "none";
       }
       return "flex";
