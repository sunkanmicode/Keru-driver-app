...
const SettingsComp = ({ otherMenu, securityData, supportData }) => {
  ...
  return (
    <View className="flex-1 bg-white p-6">
      ...
      <View>
        <View className="w-[335px] h-[55px] flex-row justify-between items-center mx-auto">
          <View>
        ...
        <ScrollView
          ...
          className="w-[349px] h-[561px] mt-10  mx-auto"
        >
          <View>
            <Text className="text-[10px] font-[400] font-[Archivo] leading-[10px] mb-3">
              Other menu
            </Text>
            <View className="w-[335px] h-[163px] border-[.05px] p-3 shadow shadow-black/5 rounded-[10px] mx-auto">
          ...
          <View className="mt-5">
            ...
            <View className="w-[335px] h-[206px] border-[.05px] p-3 shadow shadow-black/5 rounded-[10px] mx-auto">
